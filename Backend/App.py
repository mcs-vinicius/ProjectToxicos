...
app = Flask(__name__)
CORS(app, supports_credentials=True) # Habilita credenciais para sessões
app.secret_key = os.environ.get('SECRET_KEY', os.urandom(24)) # Mais seguro usar uma variável de ambiente
